...
<html>
<head>
  <title> | Clinica Veterinaria | Listado de Botiqín</title>
        ...
        <div class="x_panel">
          <br>
            <div class="title_left">
              <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-left top_search">
                <div class="input-group">
                  <a href="RegistrarBotiquin.php">
                    <button type="button" class="btn btn-dark" style="width: 300px; ">
                      <i class="fa fa-plus-square-o" style="font-size:20px">  Nuevo medicamento al botiquín</i>
                    </button> 
                  </a>
                </div>
              </div>
          ...
          <div class="x_content">
            ...
            <tr class="headings">
              ...
              <th class="column-title">MEDICAMENTOS</th>
