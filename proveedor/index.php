...
//include '../modal/ModalProveedor.php';
include '../modal/ModalDetalleProveedor.php';
?>
        ...
        <div class="x_panel">
          ...
          <div class="title_left">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-left top_search">
              <div class="input-group">
                <a href="nuevo.php"><button class="btn btn-primary button1" > <i
                    class="glyphicon glyphicon-plus-sign"></i> Agregar proveedor </button></a>
                </a>
              </div>
            </div>
          </div><br><br><br>
