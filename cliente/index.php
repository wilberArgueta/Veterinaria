        ...
        <div class="x_panel">
          ...
          <div class="title_left">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-left top_search">
              <div class="input-group">
                <a href="nuevo.php">
                  <button class="btn btn-primary button1"> <i class="glyphicon glyphicon-plus-sign"></i> Agregar cliente
                  </button>
                </a>
              </div>
            </div>
...
if (isset($_GET["q"])) {
 ...
 Listado de clientes
    ...
    $query = @mysqli_query($link, "SELECT cliente.idcliente,cliente.nombre,cliente.apellido,cliente.direccion,cliente.telefono, mascota.nombre AS mascota
   FROM cliente INNER JOIN mascota ON cliente.idmascota = mascota.idmascota");
    echo "<center>
  <div class=\"table-responsive\">
<table class=\"table table-bordered table-hover\" >
   <tr>
