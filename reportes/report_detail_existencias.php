...
<page backtop="30mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt" backimgx="center" backimgy="bottom" backimgw="100%">
    ...
    <table class="page_header" >
       <tr>
                ...
                <tr>
                  <td align=center style="width:95%; "><b>REPORTE DE PRODUCTO EXISTENCIAS</b></td>
                </tr><br>
...
$sql= "SELECT p.cod_interno as cod_interno,p.nombre as producto,p.descripcion as descripcion,c.nombre as categoria,p.cantidad as cantidad,pv.nombre as proveedor FROM  productos as p  INNER JOIN categoria as c ON (p.idcategoria=c.idcategoria) INNER JOIN stock_movimiento AS st ON (st.idproducto =p.idproducto) INNER JOIN proveedor as pv ON (st.idproveedor=pv.idproveedor)";
...
while ($row = mysqli_fetch_array($query)) {
    ...
    <table border="0.5px" align="center" cellspacing="0"  style="width: 100%; border:none; text-align: center; font-size: 11pt; color:#000; font-family:helvetica,serif;">
        ...
        <tr>
            ...
            <td style="width:20%"><?php echo utf8_decode($row['producto']); ?></td>
            <td style="width:20%"><?php echo utf8_decode($row['descripcion']); ?></td>
            <td style="width:15%"><?php echo utf8_decode($row['categoria']); ?></td>
            <td style="width:10%"><?php echo utf8_decode($row['cantidad']); ?></td>
            <td style="width:15%"><?php echo utf8_decode($row['proveedor']); ?></td>
