...
<html>
<head>
  <title> | Clinica Veterinaria | Reporte de Botiquin</title>
      ...
      <div class="col-md-12">
        <div class="x_panel">
          <section class="content-header">
            <h1>Reporte de Botiquin</h1>
            <ol class="breadcrumb">
              <li><a href="../home/"><i class="fa fa-home"></i> Home</a></li>
              <li>/ Reporte</li>
              <li class="active">Reporte de Botiquin</li>
            </ol>
          </section>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="x_panel">
            ...
            <form  role="form" method="GET" action="view_report_botiquin.php" class="form-horizontal form-label-left">
            <span class="section">Datos del Reporte</span>

            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telefono">Reporte General de Botiquin</label>
