...
<page backtop="30mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt" backimgx="center" backimgy="bottom" backimgw="100%">
    <page_header>
        ...
        <table class="page_header" >
                ...
                <tr>
                  <td align=center style="width:95%; "><b>REPORTE DE BOTIQUIN</b></td>
                </tr><br>
...
<?php
    ...
    $sql= "SELECT b.cod_estudiante as cod_estudiante,b.nombre_estudiante as estudiante,b.descripcion as descripcion,p.nombre  as producto, dtb.cantidad as cantidad
    ...
    <table border="0.5px" align="center" cellspacing="0"  style="width: 100%; border:none; text-align: center; font-size: 11pt; color:#000; font-family:helvetica,serif;">
	    ...
	    <td style="width:5%"><?php echo $i; ?></td>
           <td style="width:10%"><?php echo $row['cod_estudiante']; ?></td>
            <td style="width:15%;"><?php echo utf8_decode($row['estudiante']); ?></td>
           <td style="width:23%"><?php echo utf8_decode($row['descripcion']); ?></td>
           <td style="width:23%"><?php echo utf8_decode($row['producto']); ?></td>
