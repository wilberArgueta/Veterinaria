            ...
            <span class="section">Datos de la mascota</span>
             ...
             <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="expedienteMascota" class="form-control col-md-7 col-xs-12" readonly="readonly"  name="expedienteMascota" type="text" value="<?php echo $expediente?>">
...
<?php
 if (isset($_POST['submit'])) {
     ...
     {
      echo "<script>
     location.replace('../mascota/ListadoMascota.php?q=$nombremascota&info=modificar');
            </script>";
