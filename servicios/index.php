          ...
          <br>
            <div class="title_left">
              <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-left top_search">
                <div class="input-group">
                  <a href="nuevo.php">
                  <button class="btn btn-primary button1" > <i class="glyphicon glyphicon-plus-sign">
                  </i> Agregar servicios </button>
                  </a>
                </div>
              </div>
            </div>
...
if (isset($_GET["q"])) {
    ...
    $q = $_GET["q"];
    $query = @mysqli_query($link, "SELECT servicios.id_servicio,servicios.tipo_servicio,servicios.descripcion,servicios.precio,
    servicios.porcentaje_ganancia, cliente.nombre AS cliente FROM servicios
     INNER JOIN cliente ON servicios.idcliente = cliente.idcliente
     WHERE servicios.id_servicio LIKE '%$q%' OR servicios.tipo_servicio LIKE '%$q%' order by id_servicio");
   ...
   <table class=\"table table-bordered table-hover\" >
    ...
    $query = @mysqli_query($link, "SELECT servicios.id_servicio,servicios.tipo_servicio,servicios.descripcion,
    servicios.precio,
  servicios.porcentaje_ganancia, cliente.nombre AS cliente FROM servicios
   INNER JOIN cliente ON servicios.idcliente = cliente.idcliente");
     echo "<br><div class=\"alert alert alert-info\" role=\"alert\">
