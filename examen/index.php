...
include '../modal/ModalTipoExamen.php';
include '../modal/ModalDescripcionExamen.php';
?>
...
if (isset($_GET["q"])) {
    ...
    $q = $_GET["q"];
    $query = @mysqli_query($link, "SELECT examen.idexamen,examen.tipo_examen,examen.descripcion,examen.fecha_examen,examen.precio, laboratorio.nombre
     as laboratorio FROM examen INNER JOIN laboratorio on examen.idlaboratorio = laboratorio.idlaboratorio
      WHERE examen.idexamen LIKE '%$q%' OR examen.tipo_examen LIKE '%$q%' order by idexamen");
